  ...
  return (
    <>
      <div className="h-full relative">
        <div className="navbar border-b-2 flex justify-center md:justify-around sticky top-0 left-0 right-0 z-40 bg-base-100">
          <div className="drawer w-16 fixed left-0 top-4 md:hidden">
            <input
              id="my-drawer"
              type="checkbox"
